...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QLabel, QLineEdit, QPushButton, QComboBox, QHBoxLayout,
                             QGroupBox, QCheckBox, QTimeEdit, QSpinBox, QTabWidget, QSplashScreen, QMessageBox)
...
class AdwareBuilder(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('luai Adware Builder @FixGFATHER')
        ...
        # Title
        title = QLabel('luai Adware Builder')
    ...
    def build_tab_ui(self):
        ...
        self.ad_url_input.setStyleSheet(
            "color: white; background-color: #333; border: 1px solid red; padding: 10px; font-size: 20px; border-radius: 10px;")
        ...
        self.redirect_url_input.setStyleSheet(
            "color: white; background-color: #333; border: 1px solid red; padding: 10px; font-size: 20px; border-radius: 10px;")
        ...
        self.schedule_time_edit.setStyleSheet(
            "color: white; background-color: #333; border: 1px solid red; padding: 5px; border-radius: 10px;")
